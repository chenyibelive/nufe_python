class STUDENT2:
    ...
    def gotoclass(self, place, class_name):
    	print("{}在{}上课".format(self.student_name, place, class_name))
...
if __name__=="__main__":
    student_name1 = "小明"
    student_class2=STUDENT2(student_name1)
    print("======{}的一天======".format(student_class2.student_name))
    student_class2.eat("—食堂")
    student_class2.gotoclass("—教","Python")
    student_class2.dosport("操场","篮球")
    student_class2.study("图书馆")
    student_class2.sleep("2*号楼")